...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
 ...
 "nav.seo": "Pao SEO",
  "seo.geoCouncilRun": "Ratsprüfung ausführen",
  "seo.geoCouncilTitle": "GEO Reviewer Council",
  "seo.geoFixPlan": "Fixplan",
  "seo.geoExecutionNone": "Ausführungspfad: keiner",
  "seo.geoTechnical": "GEO-Technik",
  "seo.geoSitemap": "Sitemap",
  "seo.geoUrls": "URLs",
  "seo.geoCanonical": "Canonical",
  "seo.geoFreshness": "Aktualität",
  "seo.geoProposalTitle": "llms.txt-Vorschlag",
  "seo.geoProposalGate": "Vor der Bereitstellung ist eine menschliche Genehmigung erforderlich.",
  "seo.geoProposalCopy": "Vorschlag kopieren",
  "seo.geoProposalCopied": "Kopiert",
  "seo.geoProposalWarnings": "Warnungen",
  "seo.geoEntity": "Entitäts-Konsistenz",
  "seo.geoEntityOk": "Name konsistent in Titel und Schema",
  "seo.geoEntityMismatch": "Name weicht zwischen Titel und Schema ab",
  "seo.geoEeat": "E-E-A-T",
  "seo.geoTitle": "GEO / KI-Such-Bereitschaft",
  "seo.geoHint": "Heuristische Werte aus direkt geprüften Rohantworten — keine Ranking-Prognosen.",
  "seo.geoRun": "GEO-Audit ausführen",
  "seo.geoScore": "GEO-Score",
  "seo.geoHeuristic": "heuristisch",
  "seo.geoCitability": "Citability",
  "seo.geoSchema": "Schema-Blöcke",
  "seo.geoLlms": "llms.txt",
  "seo.geoVerify": "Verifizierung",
  "seo.title": "Pao SEO Agent OS",
  "seo.providerHealth": "SEO-Anbieterstatus",
  "seo.mode": "Modus",
  "seo.latency": "Latenz",
  "seo.security": "Sicherheit",
  "seo.projects": "SEO-Projekte",
  "seo.recommendations": "Empfehlungen",
  "seo.loadFailed": "SEO-Daten konnten nicht geladen werden.",
  "seo.noProjects": "Noch keine SEO-Projekte. Unten eines hinzufügen.",
  "seo.noRecommendations": "Noch keine Empfehlungen. Analyse ausführen.",
  "seo.selectProject": "Projekt wählen, um Empfehlungen zu sehen.",
  "seo.domainPlaceholder": "example.com",
  "seo.displayNamePlaceholder": "Anzeigename (optional)",
  "seo.seedPlaceholder": "Seed-Keywords, kommagetrennt (optional)",
  "seo.createProject": "Projekt hinzufügen",
  "seo.runAnalysis": "Analyse ausführen",
  "seo.analyzing": "Analysiere…",
  "seo.runFailed": "Analyse fehlgeschlagen",
  "seo.approve": "Genehmigen",
  "seo.dismiss": "Verwerfen",
  ...
  "nav.demo": "Demo",
  "nav.notificationGateway": "Benachrichtigungs-Gateway",
  "nav.mediaAcquisition": "Medienbeschaffung",
  "nav.universalRegistry": "Universelles Register",
  "nav.douyinWorkspace": "Douyin Intelligence",
  "nav.speechRuntime": "Sprach-Studio",
  "nav.aiWorkspace": "KI-Arbeitsbereich",
  "nav.leadIntelligence": "Lead-Intelligenz",
  "nav.unifiedRuntime": "Einheitliche Laufzeit",
  "nav.businessBuilder": "Business-Builder",
  "nav.agenticOs": "Orchestrierung",
  "nav.dependencyVault": "Abhängigkeits-Tresor",
  "nav.codingWorkspace": "Coding-Workspace",
  "nav.agentFleet": "Agenten-Flotte",
  "nav.memoryPlane": "Speicherebene",
  "nav.teammateWorkspace": "Team-Workspace",
  "nav.agentMemory": "Agenten-Gedächtnis",
  "nav.agentCockpit": "Agent-Cockpit",
  "nav.agentPlatform": "Agentenplattform",
  "nav.capabilityLab": "Capability-Labor",
  "nav.socialPublishing": "Social Publishing",
  ...
  "nav.enzoWorkspace": "KI-Betriebswerkraum",
  "nav.acquisition": "Beschaffung",
  "nav.mcpFabric": "MCP Fabric",
  "amf.kicker": "Phase 20.96",
  "amf.title": "AnythingMCP Control Plane",
  "amf.subtitle": "APIs zu verwalteten MCP-Tools. AnythingMCP ist der Worker, Pao-hubPro die Control Plane.",
  "amf.ready": "ready",
  "amf.error": "error",
  ...
  "acq.title": "Content Acquisition",
  "acq.subtitle": "Richtliniengesteuerte Aufnahme. OmniGet ist ein Worker, keine Control Plane.",
  "acq.ready": "ready",
  "acq.error": "error",
 ...
 "pws.saving": "Wird gespeichert…",
  "pws.poolSwitchTitle": "Pool wechseln (erst testen)",
  "pws.poolSwitchDesc": "Ersetzt Basis-URL, API-Key und Standardmodell in einer geprüften Transaktion. Ohne erfolgreichen Test ändert sich nichts.",
  "pws.poolSwitchRun": "Pool testen & wechseln",
  "pws.poolSwitchKeyPlaceholder": "Neuer Pool-API-Key",
  "pws.poolSwitchRequired": "Basis-URL, Standardmodell und der neue API-Key sind erforderlich.",
  "pws.poolSwitchDone": "Pool gewechselt — {models} Modelle verfügbar.",
  "pws.poolSwitchFailed": "Poolwechsel fehlgeschlagen. Der aktuelle Pool bleibt unverändert.",
  "pws.poolSwitchModelMissing": "Der Kandidaten-Pool ist erreichbar, enthält aber das Standardmodell nicht ({count} Modelle verfügbar). Wähle eines aus der Liste und versuche es erneut.",
  "pws.poolSwitchChoicesHint": "Erste {shown} von {total} Modellen aus dem Kandidaten-Pool.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "nav.social": "Social Intelligence",
  "nav.mediaMemory": "Medien-Gedächtnis",
  "nav.controlPlane": "KI-Kontrollzentrum",
  "nav.eccHarness": "ECC Agent Harness",
  "nav.codexRuntime": "Codex-Laufzeit",
  "nav.agentOrchestrator": "Agenten-Orchestrierer",
  ...
  "aiStudio.smartQueue.title": "Smart Queue & Cloud Burst Hub",
  "aiStudio.smartQueue.subtitle": "Native ComfyUI queue observer, bounded 1-running + 1-prefetch window, and automated FinOps burst scaling.",
  "aiStudio.smartQueue.burstMode": "Burst Mode",
  "aiStudio.smartQueue.modeOff": "OFF (Local Only)",
  "aiStudio.smartQueue.modeManual": "MANUAL (Plan Only)",
  "aiStudio.smartQueue.modeAssisted": "ASSISTED (1-Click Approval)",
  "aiStudio.smartQueue.modeAuto": "AUTO (Full Burst Autonomous)",
  "aiStudio.smartQueue.dispatch": "Dispatch",
  "aiStudio.smartQueue.dispatching": "DISPATCHING",
  "aiStudio.smartQueue.paused": "PAUSED",
  "aiStudio.smartQueue.pause": "Pause Dispatch",
  "aiStudio.smartQueue.resume": "Resume Dispatch",
  "aiStudio.smartQueue.refreshPlan": "Refresh Plan",
  "aiStudio.smartQueue.providerLanes": "Provider Dispatch Lanes",
  "aiStudio.smartQueue.slotRunning": "Slot 0 (Running)",
  "aiStudio.smartQueue.slotPrefetch": "Slot 1 (Prefetch)",
  "aiStudio.smartQueue.slotEmpty": "idle",
  "aiStudio.smartQueue.scalePlanTitle": "Active Scale Plan & Prediction",
  "aiStudio.smartQueue.drainEst": "Drain Prediction",
  "aiStudio.smartQueue.approveBurst": "Approve Burst & Scale Out",
  "aiStudio.smartQueue.reconciliationTitle": "Queue Reconciliation Inspector",
  "aiStudio.smartQueue.reconciledOk": "Native ComfyUI queue and SQLite backlog are perfectly aligned.",
  "aiStudio.smartQueue.resolve": "Acknowledge / Resolve",
  ...
  "sdlc.cycles": "Cycles",
  "sdlc.newCycle": "New Cycle",
  "sdlc.cycleTitle": "Cycle Title",
  "sdlc.rawIdea": "Idea / Problem Statement",
  "sdlc.create": "Start SDLC Cycle",
  "sdlc.creating": "Starting...",
  "sdlc.status": "Status",
  "sdlc.stage": "Current Stage",
  "sdlc.gate": "Current Gate",
  "sdlc.branch": "Git Branch",
  "sdlc.actions": "Actions",
  "sdlc.runSpecify": "Run /specify",
  "sdlc.runClarify": "Run /clarify",
  "sdlc.runPlan": "Run /plan",
  "sdlc.runTasks": "Run /tasks",
  "sdlc.runAnalyze": "Run /analyze",
  "sdlc.runImplement": "Run /implement",
  "sdlc.runTests": "Run /test",
  "sdlc.runReview": "Run /review",
  "sdlc.runConverge": "Run /converge",
  "sdlc.tab.overview": "Overview",
  "sdlc.tab.specs": "Spec & ACs",
  "sdlc.tab.clarifications": "Clarifications",
  "sdlc.tab.plan": "Plan & ADRs",
  "sdlc.tab.tasks": "Tasks DAG",
  "sdlc.tab.analysis": "Coverage Matrix",
  "sdlc.tab.gates": "Quality Gates",
  "sdlc.tab.reviews": "Reviewer Council",
  "sdlc.tab.approvals": "Approvals",
  "sdlc.tab.evidence": "Evidence",
  "sdlc.constitution": "Constitution",
  "sdlc.score": "Score",
  "sdlc.blockers": "Blockers",
  "sdlc.approve": "Approve",
  "sdlc.reject": "Reject",
  "sdlc.loading": "Loading SDLC cycle...",
  "sdlc.empty": "No active SDLC cycles found. Start one with an idea above!",
  "sdlc.noCycles": "No cycles available",
  "sdlc.refresh": "Refresh",
  "sdlc.cancel": "Cancel",
  "sdlc.close": "Close",
  "sdlc.token": "Approval Token",
  "sdlc.reason": "Reason / Note",
  "sdlc.decide": "Submit Decision",
  "sdlc.requirements": "Functional Requirements",
  "sdlc.acceptanceCriteria": "Acceptance Criteria",
  "sdlc.decisions": "Architecture Decisions (ADRs)",
  "sdlc.role": "Reviewer Role",
  "sdlc.consensus": "Council Consensus",
  "sdlc.severity": "Severity",
  "sdlc.findings": "Findings",
  "sdlc.risk": "Risk Level",
  "sdlc.col.key": "Key",
  "sdlc.col.title": "Title",
  "sdlc.col.complexity": "Complexity",
  "sdlc.col.acs": "ACs",
  "sdlc.col.given": "Given",
  "sdlc.col.when": "When",
  "sdlc.col.then": "Then",
  "sdlc.col.testable": "Testable",
  "sdlc.col.question": "Question",
  "sdlc.col.resolution": "Resolution",
  "sdlc.col.dependencies": "Dependencies",
  "sdlc.col.worker": "Worker",
  "sdlc.col.verdict": "Verdict",
  "sdlc.col.type": "Type",
  "sdlc.col.hash": "SHA-256 Hash",
  "sdlc.col.recordedAt": "Recorded At",
  "sdlc.col.context": "Context",
  "sdlc.col.decision": "Decision",
  "sdlc.col.consequences": "Consequences",
  "sdlc.newCyclePlaceholder": "e.g. Add Safe Payment Webhook",
  "sdlc.rawIdeaPlaceholder": "Explain the requirements, goals, and constraints...",
  "sdlc.tokenPlaceholder": "Cryptographic token if provided...",
  "sdlc.reasonPlaceholder": "Rationale for decision...",
  "sdlc.constitutionDesc": "10 Supreme Immutable Project Rules Active. Deterministic verification precedes all decisions. Clean Git tree strictly enforced.",
  "sdlc.analysisDesc": "Bidirectional Traceability Matrix: Idea -> Requirements -> Acceptance Criteria -> ADRs -> Tasks.",
  "sdlc.reqCoverage": "Requirements Coverage",
  "sdlc.acCoverage": "Acceptance Criteria Coverage",
  "sdlc.tasksCoverage": "Tasks Traceability",
};
