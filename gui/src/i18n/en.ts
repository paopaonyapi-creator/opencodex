...
"common.discard": "Discard",
 ...
 "pws.saving": "Saving…",
  "pws.poolSwitchTitle": "Switch pool (test first)",
  "pws.poolSwitchDesc": "Replaces the base URL, API key, and default model in one verified transaction. Nothing changes unless the candidate pool passes.",
  "pws.poolSwitchRun": "Test & switch pool",
  "pws.poolSwitchKeyPlaceholder": "New pool API key",
  "pws.poolSwitchRequired": "Base URL, default model, and the new API key are required.",
  "pws.poolSwitchDone": "Pool switched — {models} models available.",
  "pws.poolSwitchFailed": "Pool switch failed. The current pool is unchanged.",
  "pws.poolSwitchModelMissing": "Candidate pool is reachable, but the default model is not in it ({count} models available). Pick one from the list and try again.",
  "pws.poolSwitchChoicesHint": "First {shown} of {total} models from the candidate pool.",
...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
 ...
 "nav.seo": "Pao SEO",
  ...
  "nav.aiGateway": "AI Gateway",
   ...
   "nav.controlPlane": "AI Control Plane",
   "nav.eccHarness": "ECC Agent Harness",
   "nav.codexRuntime": "Codex Runtime",
   "nav.agentOrchestrator": "Agent Orchestrator",
 ...
 "aiStudio.runValidate": "Run validation",
  "seo.geoCouncilRun": "Run council review",
  "seo.geoCouncilTitle": "GEO Reviewer Council",
  "seo.geoFixPlan": "Fix plan",
  "seo.geoExecutionNone": "execution path: none",
  "seo.geoTechnical": "GEO technical",
  "seo.geoSitemap": "Sitemap",
  "seo.geoUrls": "URLs",
  "seo.geoCanonical": "Canonical",
  "seo.geoFreshness": "Freshness",
  "seo.geoProposalTitle": "llms.txt proposal",
  "seo.geoProposalGate": "Human approval is required before deployment.",
  "seo.geoProposalCopy": "Copy proposal",
  "seo.geoProposalCopied": "Copied",
  "seo.geoProposalWarnings": "Warnings",
  "seo.geoEntity": "Entity consistency",
  "seo.geoEntityOk": "name consistent across title and schema",
  "seo.geoEntityMismatch": "name mismatch between title and schema",
  "seo.geoEeat": "E-E-A-T",
  "seo.geoTitle": "GEO / AI-search readiness",
  "seo.geoHint": "Heuristic scores from directly verified raw responses — not platform ranking predictions.",
  "seo.geoRun": "Run GEO audit",
  "seo.geoScore": "GEO score",
  "seo.geoHeuristic": "heuristic",
  "seo.geoCitability": "Citability",
  "seo.geoSchema": "Schema blocks",
  "seo.geoLlms": "llms.txt",
  "seo.geoVerify": "Verification",
  "seo.title": "Pao SEO Agent OS",
  "seo.providerHealth": "SEO provider health",
  "seo.mode": "Mode",
  "seo.latency": "Latency",
  "seo.security": "Security",
  "seo.projects": "SEO projects",
  "seo.recommendations": "Recommendations",
  "seo.loadFailed": "Could not load SEO data.",
  "seo.noProjects": "No SEO projects yet. Add one below.",
  "seo.noRecommendations": "No recommendations yet. Run an analysis.",
  "seo.selectProject": "Select a project to see its recommendations.",
  "seo.domainPlaceholder": "example.com",
  "seo.displayNamePlaceholder": "Display name (optional)",
  "seo.seedPlaceholder": "Seed keywords, comma separated (optional)",
  "seo.createProject": "Add project",
  "seo.runAnalysis": "Run analysis",
  "seo.analyzing": "Analyzing…",
  "seo.runFailed": "Analysis failed",
  "seo.approve": "Approve",
  "seo.dismiss": "Dismiss",
  ...
  "nav.demo": "Demo",
  "nav.notificationGateway": "Notification Gateway",
  "nav.mediaAcquisition": "Media Acquisition",
  "nav.universalRegistry": "Universal Registry",
  "nav.douyinWorkspace": "Douyin Intelligence",
  "nav.speechRuntime": "Speech Studio",
  "nav.aiWorkspace": "AI Workspace",
  "nav.leadIntelligence": "Lead Intelligence",
  "nav.unifiedRuntime": "Unified Runtime",
  "nav.businessBuilder": "Business Builder",
  "nav.agenticOs": "Orchestration",
  "nav.dependencyVault": "Dependency Vault",
  "nav.codingWorkspace": "Coding Workspace",
  "nav.agentFleet": "Agent Fleet",
  "nav.memoryPlane": "Memory Plane",
  "nav.teammateWorkspace": "Teammate Workspace",
  "nav.agentMemory": "Agent Memory",
  "nav.agentCockpit": "Agent Cockpit",
  "nav.agentPlatform": "Agent Platform",
  "nav.capabilityLab": "Capability Lab",
  ...
  "nav.enzoWorkspace": "AI Operating Workspace",
  "nav.acquisition": "Acquisition",
  "nav.mcpFabric": "MCP Fabric",
  "amf.kicker": "Phase 20.96",
  "amf.title": "AnythingMCP Control Plane",
  "amf.subtitle": "Import APIs into governed MCP tools. AnythingMCP is the worker; Pao-hubPro owns policy, secrets, privacy, and approval.",
  "amf.ready": "ready",
  "amf.error": "error",
  ...
  "acq.subtitle": "Policy-governed intake. OmniGet is a worker, not the control plane.",
  "acq.ready": "ready",
  "acq.error": "error",
