...
"common.discard": "破棄",
 ...
 "pws.saving": "保存中…",
  "pws.poolSwitchTitle": "プール切替（先にテスト）",
  "pws.poolSwitchDesc": "ベースURL・APIキー・既定モデルを1回の検証済みトランザクションで置き換えます。テストが成功するまで何も変更されません。",
  "pws.poolSwitchRun": "テストしてプールを切替",
  "pws.poolSwitchKeyPlaceholder": "新しいプールのAPIキー",
  "pws.poolSwitchRequired": "ベースURL・既定モデル・新しいAPIキーは必須です。",
  "pws.poolSwitchDone": "プールを切替ました — {models} 個のモデルが利用可能。",
  "pws.poolSwitchFailed": "プール切替に失敗しました。現在のプールは変更されていません。",
  "pws.poolSwitchModelMissing": "候補プールには接続できましたが、既定モデルが含まれていません（利用可能 {count} モデル）。一覧から選んで再試行してください。",
  "pws.poolSwitchChoicesHint": "候補プールの {total} モデル中最初の {shown} 件。",
...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
 ...
 "aiStudio.auditTitle": "Audit trail",
  ...
  "aiStudio.smartQueue.title": "スマートキュー＆クラウドバーストハブ",
  "aiStudio.smartQueue.subtitle": "ComfyUI ネイティブキュー監視、1 実行中 + 1 先行取得の有界ウィンドウ、自動 FinOps クラウドバーストスケーリング。",
  "aiStudio.smartQueue.burstMode": "バーストモード",
  "aiStudio.smartQueue.modeOff": "オフ (ローカルのみ)",
  "aiStudio.smartQueue.modeManual": "手動 (計画のみ)",
  "aiStudio.smartQueue.modeAssisted": "アシスト (1クリック承認)",
  "aiStudio.smartQueue.modeAuto": "自動 (完全自律バースト)",
  "aiStudio.smartQueue.dispatch": "ディスパッチ",
  "aiStudio.smartQueue.dispatching": "ディスパッチ中",
  "aiStudio.smartQueue.paused": "一時停止中",
  "aiStudio.smartQueue.pause": "ディスパッチ一時停止",
  "aiStudio.smartQueue.resume": "ディスパッチ再開",
  "aiStudio.smartQueue.refreshPlan": "計画を更新",
  "aiStudio.smartQueue.providerLanes": "プロバイダーディスパッチレーン",
  "aiStudio.smartQueue.slotRunning": "スロット 0 (実行中)",
  "aiStudio.smartQueue.slotPrefetch": "スロット 1 (先行取得)",
  "aiStudio.smartQueue.slotEmpty": "待機中",
  "aiStudio.smartQueue.scalePlanTitle": "アクティブなスケール計画と予測",
  "aiStudio.smartQueue.drainEst": "ドレイン時間予測",
  "aiStudio.smartQueue.approveBurst": "バーストを承認してスケールアウト",
  "aiStudio.smartQueue.reconciliationTitle": "キュー整合性インスペクター",
  "aiStudio.smartQueue.reconciledOk": "ネイティブ ComfyUI キューと SQLite バックログは完全に一致しています。",
  "aiStudio.smartQueue.resolve": "確認 / 解決済みにする",
  "seo.geoCouncilRun": "評議会レビューを実行",
  "seo.geoCouncilTitle": "GEO Reviewer Council",
  "seo.geoFixPlan": "修正プラン",
  "seo.geoExecutionNone": "実行パス: なし",
  "seo.geoTechnical": "GEO技術",
  "seo.geoSitemap": "Sitemap",
  "seo.geoUrls": "URL",
  "seo.geoCanonical": "Canonical",
  "seo.geoFreshness": "鮮度",
  "seo.geoProposalTitle": "llms.txt 提案",
  "seo.geoProposalGate": "デプロイ前に人の承認が必要です。",
  "seo.geoProposalCopy": "提案をコピー",
  "seo.geoProposalCopied": "コピー済み",
  "seo.geoProposalWarnings": "警告",
  "seo.geoEntity": "エンティティ整合性",
  "seo.geoEntityOk": "title と schema で名前が一致",
  "seo.geoEntityMismatch": "title と schema で名前が不一致",
  "seo.geoEeat": "E-E-A-T",
  "seo.geoTitle": "GEO / AI検索対応",
  "seo.geoHint": "直接検証した生レスポンスに基づくヒューリスティック値 — プラットフォーム順位の予測ではありません。",
  "seo.geoRun": "GEO監査を実行",
  "seo.geoScore": "GEOスコア",
  "seo.geoHeuristic": "ヒューリスティック",
  "seo.geoCitability": "Citability",
  "seo.geoSchema": "Schemaブロック",
  "seo.geoLlms": "llms.txt",
  "seo.geoVerify": "検証",
  "seo.title": "Pao SEO Agent OS",
  "seo.providerHealth": "SEOプロバイダの状態",
  "seo.mode": "モード",
  "seo.latency": "レイテンシ",
  "seo.security": "セキュリティ",
  "seo.projects": "SEOプロジェクト",
  "seo.recommendations": "推奨事項",
  "seo.loadFailed": "SEOデータを読み込めませんでした。",
  "seo.noProjects": "SEOプロジェクトはまだありません。下から追加してください。",
  "seo.noRecommendations": "推奨事項はまだありません。分析を実行してください。",
  "seo.selectProject": "プロジェクトを選択すると推奨事項が表示されます。",
  "seo.domainPlaceholder": "example.com",
  "seo.displayNamePlaceholder": "表示名（任意）",
  "seo.seedPlaceholder": "シードキーワード（カンマ区切り・任意）",
  "seo.createProject": "プロジェクト追加",
  "seo.runAnalysis": "分析を実行",
  "seo.analyzing": "分析中…",
  "seo.runFailed": "分析に失敗しました",
  "seo.approve": "承認",
  "seo.dismiss": "却下",
  ...
  "nav.demo": "デモ",
  "nav.notificationGateway": "通知ゲートウェイ",
  "nav.mediaAcquisition": "メディア取得",
  "nav.universalRegistry": "ユニバーサルレジストリ",
  "nav.douyinWorkspace": "Douyinインテリジェンス",
  "nav.speechRuntime": "音声スタジオ",
  "nav.aiWorkspace": "AIワークスペース",
  "nav.leadIntelligence": "リードインテリジェンス",
  "nav.unifiedRuntime": "統合ランタイム",
  "nav.businessBuilder": "ビジネスビルダー",
  "nav.agenticOs": "オーケストレーション",
  "nav.dependencyVault": "依存関係ヴォールト",
  "nav.codingWorkspace": "コーディングワークスペース",
  "nav.agentFleet": "エージェントフリート",
  "nav.memoryPlane": "メモリプレーン",
  "nav.teammateWorkspace": "チームメイトワークスペース",
  "nav.agentMemory": "エージェントメモリ",
  "nav.agentCockpit": "エージェントコックピット",
  "nav.agentPlatform": "エージェントプラットフォーム",
  "nav.capabilityLab": "ケーパビリティラボ",
  "nav.socialPublishing": "ソーシャル投稿",
  ...
  "acq.title": "コンテンツ取得",
  "acq.subtitle": "ポリシー管理の取り込み。OmniGet はワーカーでありコントロールプレーンではない。",
  "acq.ready": "ready",
  "acq.error": "error",
  ...
  "nav.sdlc": "SDLC コマンドセンター",
  "sdlc.title": "Pao 仕様駆動型 AI SDLC",
  "sdlc.subtitle": "品質ゲートとレビュー評議会を備えた自律型ソフトウェアエンジニアリング運用レイヤー",
  "sdlc.cycles": "開発サイクル",
  "sdlc.newCycle": "新規サイクル",
  "sdlc.cycleTitle": "サイクル名",
  "sdlc.rawIdea": "アイデア / 課題定義",
  "sdlc.create": "SDLC サイクル開始",
  "sdlc.creating": "開始中...",
  "sdlc.status": "ステータス",
  "sdlc.stage": "現在のステージ",
  "sdlc.gate": "現在のゲート",
  "sdlc.branch": "Git ブランチ",
  "sdlc.actions": "アクション",
  "sdlc.runSpecify": "/specify を実行",
  "sdlc.runClarify": "/clarify を実行",
  "sdlc.runPlan": "/plan を実行",
  "sdlc.runTasks": "/tasks を実行",
  "sdlc.runAnalyze": "/analyze を実行",
  "sdlc.runImplement": "/implement を実行",
  "sdlc.runTests": "/test を実行",
  "sdlc.runReview": "/review を実行",
  "sdlc.runConverge": "/converge を実行",
  "sdlc.tab.overview": "概要",
  "sdlc.tab.specs": "仕様 & AC",
  "sdlc.tab.clarifications": "要件の明確化",
  "sdlc.tab.plan": "設計 & ADR",
  "sdlc.tab.tasks": "タスク DAG",
  "sdlc.tab.analysis": "追跡カバレッジマトリクス",
  "sdlc.tab.gates": "品質ゲート",
  "sdlc.tab.reviews": "レビュー評議会",
  "sdlc.tab.approvals": "承認",
  "sdlc.tab.evidence": "検証証拠",
  "sdlc.constitution": "プロジェクト憲法",
  "sdlc.score": "スコア",
  "sdlc.blockers": "ブロッキング要因",
  "sdlc.approve": "承認",
  "sdlc.reject": "却下",
  "sdlc.loading": "SDLC サイクルを読み込み中...",
  "sdlc.empty": "アクティブな SDLC サイクルがありません。上でアイデアを入力して開始してください！",
  "sdlc.noCycles": "利用可能なサイクルがありません",
  "sdlc.refresh": "更新",
  "sdlc.cancel": "キャンセル",
  "sdlc.close": "閉じる",
  "sdlc.token": "承認トークン",
  "sdlc.reason": "理由 / メモ",
  "sdlc.decide": "決定を送信",
  "sdlc.requirements": "機能要件",
  "sdlc.acceptanceCriteria": "受入基準",
  "sdlc.decisions": "アーキテクチャ決定記録 (ADR)",
  "sdlc.role": "レビュアー役割",
  "sdlc.consensus": "評議会合意",
  "sdlc.severity": "重大度",
  "sdlc.findings": "指摘事項",
  "sdlc.risk": "リスクレベル",
  "sdlc.col.key": "キー",
  "sdlc.col.title": "タイトル",
  "sdlc.col.complexity": "複雑度",
  "sdlc.col.acs": "受入基準数",
  "sdlc.col.given": "前提条件",
  "sdlc.col.when": "実行条件",
  "sdlc.col.then": "期待結果",
  "sdlc.col.testable": "テスト可",
  "sdlc.col.question": "質問",
  "sdlc.col.resolution": "解決策",
  "sdlc.col.dependencies": "依存関係",
  "sdlc.col.worker": "担当者",
  "sdlc.col.verdict": "判定",
  "sdlc.col.type": "種別",
  "sdlc.col.hash": "SHA-256 ハッシュ",
  "sdlc.col.recordedAt": "記録日時",
  "sdlc.col.context": "コンテキスト",
  "sdlc.col.decision": "決定事項",
  "sdlc.col.consequences": "影響・結果",
  "sdlc.newCyclePlaceholder": "例: 安全な決済 Webhook の追加",
  "sdlc.rawIdeaPlaceholder": "要件、目標、制約を記載してください...",
  "sdlc.tokenPlaceholder": "承認トークンがあれば入力...",
  "sdlc.reasonPlaceholder": "判断理由...",
  "sdlc.constitutionDesc": "10項目の最高不変プロジェクト憲法が適用中。すべての判断に先立ち決定論的検証を実行。クリーンな Git ツリーを強制。",
  "sdlc.analysisDesc": "双方向トレーサビリティマトリクス: アイデア -> 要件 -> 受入基準 -> ADR -> タスク。",
  "sdlc.reqCoverage": "要件カバレッジ",
  "sdlc.acCoverage": "受入基準カバレッジ",
  ...
  "nav.social": "ソーシャルインテリジェンス",
  "nav.mediaMemory": "メディアメモリ",
  "nav.controlPlane": "AI コントロールプレーン",
  "nav.eccHarness": "ECC エージェントハーネス",
  "nav.codexRuntime": "Codex ランタイム",
  "nav.agentOrchestrator": "エージェントオーケストレーター",
};
