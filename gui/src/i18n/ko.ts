...
"common.discard": "버리기",
 ...
 "aiStudio.auditTitle": "Audit trail",
  ...
  "aiStudio.smartQueue.title": "스마트 큐 & 클라우드 버스트 허브",
  "aiStudio.smartQueue.subtitle": "네이티브 ComfyUI 큐 관측, 제한된 1 실행 + 1 프리페치 윈도우, 자동 FinOps 클라우드 버스트 확장.",
  "aiStudio.smartQueue.burstMode": "버스트 모드",
  "aiStudio.smartQueue.modeOff": "끄기 (로컬 전용)",
  "aiStudio.smartQueue.modeManual": "수동 (계획만 생성)",
  "aiStudio.smartQueue.modeAssisted": "어시스트 (1클릭 승인)",
  "aiStudio.smartQueue.modeAuto": "자동 (완전 자율 버스트)",
  "aiStudio.smartQueue.dispatch": "디스패치",
  "aiStudio.smartQueue.dispatching": "디스패치 진행 중",
  "aiStudio.smartQueue.paused": "일시 정지됨",
  "aiStudio.smartQueue.pause": "디스패치 일시 정지",
  "aiStudio.smartQueue.resume": "디스패치 재개",
  "aiStudio.smartQueue.refreshPlan": "계획 새로고침",
  "aiStudio.smartQueue.providerLanes": "노드 디스패치 레인",
  "aiStudio.smartQueue.slotRunning": "슬롯 0 (실행 중)",
  "aiStudio.smartQueue.slotPrefetch": "슬롯 1 (프리페치)",
  "aiStudio.smartQueue.slotEmpty": "대기 중",
  "aiStudio.smartQueue.scalePlanTitle": "활성 스케일 계획 및 예측",
  "aiStudio.smartQueue.drainEst": "처리 완료 예측",
  "aiStudio.smartQueue.approveBurst": "버스트 승인 및 스케일 아웃",
  "aiStudio.smartQueue.reconciliationTitle": "큐 정합성 인스펙터",
  "aiStudio.smartQueue.reconciledOk": "네이티브 ComfyUI 큐와 SQLite 백로그가 완벽하게 일치합니다.",
  "aiStudio.smartQueue.resolve": "확인 / 해결됨 표시",
  "seo.geoCouncilRun": "심의회 검토 실행",
  "seo.geoCouncilTitle": "GEO Reviewer Council",
  "seo.geoFixPlan": "수정 계획",
  "seo.geoExecutionNone": "실행 경로: 없음",
  "seo.geoTechnical": "GEO 기술",
  "seo.geoSitemap": "Sitemap",
  "seo.geoUrls": "URL",
  "seo.geoCanonical": "Canonical",
  "seo.geoFreshness": "최신성",
  "seo.geoProposalTitle": "llms.txt 제안",
  "seo.geoProposalGate": "배포 전에 사람의 승인이 필요합니다.",
  "seo.geoProposalCopy": "제안 복사",
  "seo.geoProposalCopied": "복사됨",
  "seo.geoProposalWarnings": "경고",
  "seo.geoEntity": "엔티티 일관성",
  "seo.geoEntityOk": "title과 schema에서 이름 일치",
  "seo.geoEntityMismatch": "title과 schema의 이름 불일치",
  "seo.geoEeat": "E-E-A-T",
  "seo.geoTitle": "GEO / AI 검색 준비도",
  "seo.geoHint": "직접 검증한 원시 응답 기반 휴리스틱 점수 — 플랫폼 순위 예측이 아닙니다.",
  "seo.geoRun": "GEO 감사 실행",
  "seo.geoScore": "GEO 점수",
  "seo.geoHeuristic": "휴리스틱",
  "seo.geoCitability": "Citability",
  "seo.geoSchema": "Schema 블록",
  "seo.geoLlms": "llms.txt",
  "seo.geoVerify": "검증",
  "seo.title": "Pao SEO Agent OS",
  "seo.providerHealth": "SEO 공급자 상태",
  "seo.mode": "모드",
  "seo.latency": "지연 시간",
  "seo.security": "보안",
  "seo.projects": "SEO 프로젝트",
  "seo.recommendations": "추천",
  "seo.loadFailed": "SEO 데이터를 로드하지 못했습니다.",
  "seo.noProjects": "SEO 프로젝트가 없습니다. 아래에서 추가하세요.",
  "seo.noRecommendations": "추천이 없습니다. 분석을 실행하세요.",
  "seo.selectProject": "프로젝트를 선택하면 추천이 표시됩니다.",
  "seo.domainPlaceholder": "example.com",
  "seo.displayNamePlaceholder": "표시 이름(선택)",
  "seo.seedPlaceholder": "시드 키워드, 쉼표 구분(선택)",
  "seo.createProject": "프로젝트 추가",
  "seo.runAnalysis": "분석 실행",
  "seo.analyzing": "분석 중…",
  "seo.runFailed": "분석 실패",
  "seo.approve": "승인",
  "seo.dismiss": "무시",
  ...
  "nav.demo": "데모",
  "nav.notificationGateway": "알림 게이트웨이",
  "nav.mediaAcquisition": "미디어 수집",
  "nav.universalRegistry": "범용 레지스트리",
  "nav.douyinWorkspace": "더우인 인텔리전스",
  "nav.speechRuntime": "스피치 스튜디오",
  "nav.aiWorkspace": "AI 워크스페이스",
  "nav.leadIntelligence": "리드 인텔리전스",
  "nav.unifiedRuntime": "통합 런타임",
  "nav.businessBuilder": "비즈니스 빌더",
  "nav.agenticOs": "오케스트레이션",
  "nav.dependencyVault": "의존성 볼트",
  "nav.codingWorkspace": "코딩 워크스페이스",
  "nav.agentFleet": "에이전트 함대",
  "nav.memoryPlane": "메모리 플레인",
  "nav.teammateWorkspace": "팀메이트 워크스페이스",
  "nav.agentMemory": "에이전트 메모리",
  "nav.agentCockpit": "에이전트 코크핏",
  "nav.agentPlatform": "에이전트 플랫폼",
  "nav.capabilityLab": "기능 랩",
  "nav.socialPublishing": "소셜 퍼블리싱",
  ...
  "acq.title": "콘텐츠 수집",
  "acq.subtitle": "정책이 관리하는 수집. OmniGet은 워커이지 컨트롤 플레인이 아닙니다.",
  "acq.ready": "ready",
  "acq.error": "error",
...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "pws.saving": "저장 중…",
  "pws.poolSwitchTitle": "풀 전환(먼저 테스트)",
  "pws.poolSwitchDesc": "베이스 URL, API 키, 기본 모델을 한 번의 검증된 트랜잭션으로 교체합니다. 테스트가 통과하기 전까지는 아무것도 바뀌지 않습니다.",
  "pws.poolSwitchRun": "테스트 후 풀 전환",
  "pws.poolSwitchKeyPlaceholder": "새 풀 API 키",
  "pws.poolSwitchRequired": "베이스 URL, 기본 모델, 새 API 키가 필요합니다.",
  "pws.poolSwitchDone": "풀 전환 완료 — {models}개 모델 사용 가능.",
  "pws.poolSwitchFailed": "풀 전환에 실패했습니다. 현재 풀은 변경되지 않았습니다.",
  "pws.poolSwitchModelMissing": "후보 풀에 연결되었지만 기본 모델이 없습니다(사용 가능 모델 {count}개). 목록에서 선택 후 다시 시도하세요.",
  "pws.poolSwitchChoicesHint": "후보 풀 {total}개 모델 중 처음 {shown}개.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "nav.sdlc": "SDLC 커맨드 센터",
  "sdlc.title": "Pao 명세 기반 AI SDLC",
  "sdlc.subtitle": "품질 게이트 및 검토 위원회가 포함된 자율 소프트웨어 엔지니어링 운영 계층",
  "sdlc.cycles": "개발 주기",
  "sdlc.newCycle": "새 주기",
  "sdlc.cycleTitle": "주기 제목",
  "sdlc.rawIdea": "아이디어 / 문제 정의",
  "sdlc.create": "SDLC 주기 시작",
  "sdlc.creating": "시작 중...",
  "sdlc.status": "상태",
  "sdlc.stage": "현재 단계",
  "sdlc.gate": "현재 게이트",
  "sdlc.branch": "Git 브랜치",
  "sdlc.actions": "작업",
  "sdlc.runSpecify": "/specify 실행",
  "sdlc.runClarify": "/clarify 실행",
  "sdlc.runPlan": "/plan 실행",
  "sdlc.runTasks": "/tasks 실행",
  "sdlc.runAnalyze": "/analyze 실행",
  "sdlc.runImplement": "/implement 실행",
  "sdlc.runTests": "/test 실행",
  "sdlc.runReview": "/review 실행",
  "sdlc.runConverge": "/converge 실행",
  "sdlc.tab.overview": "개요",
  "sdlc.tab.specs": "명세 및 인수 기준",
  "sdlc.tab.clarifications": "요구사항 명확화",
  "sdlc.tab.plan": "계획 및 ADR",
  "sdlc.tab.tasks": "태스크 DAG",
  "sdlc.tab.analysis": "추적성 매트릭스",
  "sdlc.tab.gates": "품질 게이트",
  "sdlc.tab.reviews": "검토 위원회",
  "sdlc.tab.approvals": "승인",
  "sdlc.tab.evidence": "검증 증거",
  "sdlc.constitution": "프로젝트 헌법",
  "sdlc.score": "점수",
  "sdlc.blockers": "차단 요소",
  "sdlc.approve": "승인",
  "sdlc.reject": "반려",
  "sdlc.loading": "SDLC 주기 로드 중...",
  "sdlc.empty": "활성 SDLC 주기가 없습니다. 위에서 아이디어를 입력해 시작하세요!",
  "sdlc.noCycles": "사용 가능한 주기가 없습니다",
  "sdlc.refresh": "새로고침",
  "sdlc.cancel": "취소",
  "sdlc.close": "닫기",
  "sdlc.token": "승인 토큰",
  "sdlc.reason": "사유 / 메모",
  "sdlc.decide": "결정 제출",
  "sdlc.requirements": "기능 요구사항",
  "sdlc.acceptanceCriteria": "인수 기준",
  "sdlc.decisions": "아키텍처 결정 기록 (ADR)",
  "sdlc.role": "검토자 역할",
  "sdlc.consensus": "위원회 합의",
  "sdlc.severity": "심각도",
  "sdlc.findings": "발견 사항",
  "sdlc.risk": "위험도",
  "sdlc.col.key": "키",
  "sdlc.col.title": "제목",
  "sdlc.col.complexity": "복잡도",
  "sdlc.col.acs": "인수수",
  "sdlc.col.given": "전제 조건",
  "sdlc.col.when": "실행 조건",
  "sdlc.col.then": "예상 결과",
  "sdlc.col.testable": "테스트 가능",
  "sdlc.col.question": "질문",
  "sdlc.col.resolution": "해결 방안",
  "sdlc.col.dependencies": "의존성",
  "sdlc.col.worker": "담당자",
  "sdlc.col.verdict": "판정",
  "sdlc.col.type": "유형",
  "sdlc.col.hash": "SHA-256 해시",
  "sdlc.col.recordedAt": "기록 시간",
  "sdlc.col.context": "맥락",
  "sdlc.col.decision": "결정",
  "sdlc.col.consequences": "결과 영향",
  "sdlc.newCyclePlaceholder": "예: 안전한 결제 웹훅 추가",
  "sdlc.rawIdeaPlaceholder": "요구사항, 목표 및 제약사항을 설명하세요...",
  "sdlc.tokenPlaceholder": "제공된 승인 토큰...",
  "sdlc.reasonPlaceholder": "결정 사유...",
  "sdlc.constitutionDesc": "10대 최고 불변 프로젝트 규칙 적용 중. 결정론적 검증이 모든 결정에 선행. 깨끗한 Git 트리 엄격 강제.",
  "sdlc.analysisDesc": "양방향 추적성 매트릭스: 아이디어 -> 요구사항 -> 인수 기준 -> ADR -> 태스크.",
  "sdlc.reqCoverage": "요구사항 커버리지",
  ...
  "nav.eccHarness": "ECC 에이전트 하네스",
  "nav.codexRuntime": "Codex 런타임",
  "nav.agentOrchestrator": "에이전트 오케스트레이터",
};
