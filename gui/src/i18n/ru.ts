...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "anthropicPool.enabledNoQuotaDesc": "При 429 аккаунт охлаждается и выполняется переключение. Выбор новых сессий по квоте отключён; сохраняются здоровая привязка и маршрутизация через активный аккаунт.",
