...
"common.discard": "丢弃",
 ...
 "nav.seo": "Pao SEO",
  "seo.geoCouncilRun": "运行评议会审查",
  "seo.geoCouncilTitle": "GEO Reviewer Council",
  "seo.geoFixPlan": "修复计划",
  "seo.geoExecutionNone": "执行路径：无",
  "seo.geoTechnical": "GEO 技术",
  "seo.geoSitemap": "Sitemap",
  "seo.geoUrls": "URL",
  "seo.geoCanonical": "Canonical",
  "seo.geoFreshness": "新鲜度",
  "seo.geoProposalTitle": "llms.txt 提案",
  "seo.geoProposalGate": "部署前必须经过人工批准。",
  "seo.geoProposalCopy": "复制提案",
  "seo.geoProposalCopied": "已复制",
  "seo.geoProposalWarnings": "警告",
  "seo.geoEntity": "实体一致性",
  "seo.geoEntityOk": "title 与 schema 中的名称一致",
  "seo.geoEntityMismatch": "title 与 schema 中的名称不一致",
  "seo.geoEeat": "E-E-A-T",
  "seo.geoTitle": "GEO / AI 搜索就绪度",
  "seo.geoHint": "基于直接验证的原始响应的启发式评分 — 并非平台排名预测。",
  "seo.geoRun": "运行 GEO 审计",
  "seo.geoScore": "GEO 分数",
  "seo.geoHeuristic": "启发式",
  "seo.geoCitability": "可引用性",
  "seo.geoSchema": "Schema 块",
  "seo.geoLlms": "llms.txt",
  "seo.geoVerify": "验证情况",
  "seo.title": "Pao SEO Agent OS",
  "seo.providerHealth": "SEO 服务商状态",
  "seo.mode": "模式",
  "seo.latency": "延迟",
  "seo.security": "安全",
  "seo.projects": "SEO 项目",
  "seo.recommendations": "建议",
  "seo.loadFailed": "无法加载 SEO 数据。",
  "seo.noProjects": "还没有 SEO 项目。在下方添加。",
  "seo.noRecommendations": "还没有建议。先运行分析。",
  "seo.selectProject": "选择项目以查看建议。",
  "seo.domainPlaceholder": "example.com",
  "seo.displayNamePlaceholder": "显示名称（可选）",
  "seo.seedPlaceholder": "种子关键词，逗号分隔（可选）",
  "seo.createProject": "添加项目",
  "seo.runAnalysis": "运行分析",
  "seo.analyzing": "分析中…",
  "seo.runFailed": "分析失败",
  "seo.approve": "批准",
  "seo.dismiss": "忽略",
  ...
  "nav.demo": "演示",
  "nav.notificationGateway": "通知网关",
  "nav.mediaAcquisition": "媒体获取",
  "nav.universalRegistry": "通用注册表",
  "nav.douyinWorkspace": "抖音智能分析",
  "nav.speechRuntime": "语音工作室",
  "nav.aiWorkspace": "AI 工作区",
  "nav.leadIntelligence": "线索情报",
  "nav.unifiedRuntime": "统一运行时",
  "nav.businessBuilder": "商业构建器",
  "nav.agenticOs": "编排中心",
  "nav.dependencyVault": "依赖保险库",
  "nav.codingWorkspace": "编码工作区",
  "nav.agentFleet": "智能体舰队",
  "nav.memoryPlane": "记忆平面",
  "nav.teammateWorkspace": "队友工作区",
  "nav.agentMemory": "智能体记忆",
  "nav.agentCockpit": "智能体驾驶舱",
  "nav.agentPlatform": "智能体平台",
  "nav.capabilityLab": "能力实验室",
  "nav.socialPublishing": "社交发布",
  ...
  "acq.title": "内容采集",
  "acq.subtitle": "受策略约束的采集。OmniGet 是 worker，不是控制面。",
  "acq.ready": "ready",
  "acq.error": "error",
...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
 ...
 "pws.saving": "保存中…",
  "pws.poolSwitchTitle": "切换资源池（先测试）",
  "pws.poolSwitchDesc": "以一次通过验证的事务替换基础 URL、API 密钥和默认模型。测试失败时保持原配置不变。",
  "pws.poolSwitchRun": "测试并切换资源池",
  "pws.poolSwitchKeyPlaceholder": "新资源池的 API 密钥",
  "pws.poolSwitchRequired": "需要基础 URL、默认模型和新 API 密钥。",
  "pws.poolSwitchDone": "资源池已切换 — {models} 个模型可用。",
  "pws.poolSwitchFailed": "切换资源池失败。当前资源池保持不变。",
  "pws.poolSwitchModelMissing": "候选资源池可访问，但缺少默认模型（可用模型 {count} 个）。请从列表选择后重试。",
  "pws.poolSwitchChoicesHint": "候选资源池 {total} 个模型中的前 {shown} 个。",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "nav.eccHarness": "ECC 智能体线束",
  "nav.codexRuntime": "Codex 运行时",
  "nav.agentOrchestrator": "智能体编排器",
